//package main.view;
//
//import com.sergeev.controller.CarController;
//import com.sergeev.model.Car;
//import com.sergeev.model.Type;
//
...
//    Map<Integer, List<Integer>> carAndSeats;
//
...
//    }
//
//    public List<String> getSeatsOpen(Map<Integer, List<Integer>> carAndSeats) {
//        List<String> seatOpen = new ArrayList<>();
//        for (Map.Entry<Integer, List<Integer>> pair : carAndSeats.entrySet()) {
//
